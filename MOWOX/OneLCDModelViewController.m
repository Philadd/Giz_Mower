...
#import "OneLCDModelHelpViewController.h"
#import "AirLinkViewController.h"

@interface OneLCDModelViewController ()
...
@implementation OneLCDModelViewController
...
- (UIImageView *)oneModelImage{
    if (!_oneModelImage) {
        ...
        UIImageView *upTwoImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"img_lcdModelHelp1"]];
        [_oneModelImage addSubview:upTwoImage];
...
- (void)goOneHelp{
    ...
    OneLCDModelHelpViewController *HelpVC = [[OneLCDModelHelpViewController alloc] init];
