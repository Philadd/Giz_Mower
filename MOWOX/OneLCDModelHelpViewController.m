//
//  OneLCDModelHelpViewController.m
//  Giz_Mower
//
...
@interface OneLCDModelHelpViewController ()
...
@implementation OneLCDModelHelpViewController
...
- (UILabel *)modelLabel_1{
    if (!_modelLabel_1) {
        ...
        _modelLabel_1.text = LocalString(@"Model1:");
...
- (UILabel *)modelLabel_2{
    if (!_modelLabel_2) {
        ...
        _modelLabel_2.text = LocalString(@"more compatible to 2.4GHZ Wifi network,more convenient on operation");
